<template>
    <div class="sideBox">
        ...
        <div class="sideBox__main" :class="{ 'sideBox__main--open': sideBoxOpen}">
            <img src="https://cooluid-1256153771.cos.ap-guangzhou.myqcloud.com/IMG_8894.JPG" alt="" class="sideBox__img"
                 @click="backToIndex">
            <p class="sideBox__name">xxxx.cool</p>
            ...
            <ul class="sideBox__tagList" v-if="isInList">
                <li v-for="tag in tags" class="sideBox__tagItem"
            ...
            <div class="categoryBox" v-if="!isInList" :class="{ 'categoryBox--fixed': (scrollTop > 270)}"
                 ref="categoryBox">
